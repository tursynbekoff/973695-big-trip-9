...
render(tripMain, tripInfo(getTripDestination.originalDestination,
    getTripDestination.finallDestination,
    getTripDestination.startDate,
    getTripDestination.endDate), `afterbegin`);
