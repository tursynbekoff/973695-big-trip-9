...
export default class EditTripDestination extends AbstractComponent {
      ...
      <form class="event  event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            ...
            <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${this._intermediateCity}" list="destination-list-1">
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${new Date(this._startDate).getDate()}/${new Date(this._startDate).getMonth() + 1}/${new Date(this._startDate).getYear() - 100} ${this._intermediateStartTime}">
            &mdash;
            <label class="visually-hidden" for="event-end-time-1">
              To
            </label>
            <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${new Date(this._startDate).getDate()}/${new Date(this._startDate).getMonth() + 1}/${new Date(this._startDate).getYear() - 100} ${this._intermediateEndTime}">
          </div>
